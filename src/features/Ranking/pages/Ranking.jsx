...
const Ranking = () => {
  ...
  const categoryData = {
    ...
    aprendices: {
      ...
      ranking: [
        ...
        { id: 11, name: "Zurangely Portillo", points: 382, ficha: "2889927-801" },
        ...
        { id: 23, name: "Sebastián Morales", points: 320, ficha: "2889927-801" },
        ...
        { id: 27, name: "Nicolás Fernández", points: 300, ficha: "2889927-801" },
        { id: 28, name: "Luciana Gutiérrez", points: 295, ficha: "2889927-801" },
  ...
  useEffect(() => {
    ...
    const endIndex = Math.min(startIndex + itemsPerPage, currentData.ranking.length)
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="text-sm text-gray-600 flex items-center">
            ...
            Mostrando {displayedItems.length} de {currentData.ranking.length} participantes
          </div>
