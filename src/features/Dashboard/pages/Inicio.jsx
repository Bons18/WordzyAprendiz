    ...
    <div className="flex flex-col items-center justify-center bg-gray-100 min-h-screen w-full p-5">
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-5 border-b">
          <h1 className="text-xl font-bold text-center text-[#1f384c]">
            WELCOME BACK, DANIEL!
          </h1>
        </div>
        ...
        {/* Learning Path */}
        <div className="p-4">
          <h2 className="text-lg font-bold text-[#1f384c] mb-3">
              ...
              <div className="p-3 border-t">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex-1 bg-gray-200 rounded-full h-2.5">
                    <div
                      className="bg-[#1f384c] h-2.5 rounded-full"
                      style={{ width: "65%" }}
                    ></div>
                  </div>
                    ...
                    <div className="p-3 border-t">
                      ...
                      <div className="flex justify-between items-center mt-4 mb-4 border-b pb-2">
                        <div className="flex items-center">
                          ...
                          <p className="text-sm">
                            Material de apoyo: Beginners guide to english
                            pronunciation
                          </p>
                        </div>
                        <button
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center">
                            ...
                            <span
                              className={`ml-2 text-xs font-medium ${getScoreColor(
                                85
                              )}`}
                            >
                              85/100
                          ...
                          <button
                            ...
                            className={`${getButtonColor(
                              85
                            )} rounded-md px-3 py-1 text-xs transition-colors duration-300`}
                          >
                            Repetir
                          </button>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            onClick={() =>
                              handleStartExam("Introducing yourself")
                            }
                            className={`${getButtonColor(
                              92
                            )} rounded-md px-3 py-1 text-xs transition-colors duration-300`}
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            onClick={() =>
                              handleStartExam("Greeting & Introductions")
                            }
                            className={`${getButtonColor(
                              78
                            )} rounded-md px-3 py-1 text-xs transition-colors duration-300`}
                    ...
                    <div className="p-3 border-t">
                      ...
                      <div className="flex justify-between items-center mt-4 mb-4 border-b pb-2">
                        <div className="flex items-center">
                          <FileText size={16} className="mr-2" />
                          <p className="text-sm">
                            Material de apoyo: Simple Present
                          </p>
                        </div>
                        <button
                          onClick={() => {
            ...
            <div className="border rounded-md p-3 flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  El nivel se habilitará en el trimestre correspondiente
                </p>
              </div>
            </div>
